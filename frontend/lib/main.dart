        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                _NavItem(icon: Icons.home_rounded, label: '首页', isSelected: _selectedIndex == 0, onTap: () => setState(() => _selectedIndex = 0)),
                _NavItem(icon: Icons.explore_rounded, label: '发现', isSelected: _selectedIndex == 1, onTap: () => setState(() => _selectedIndex = 1)),
                _NavItem(icon: Icons.person_rounded, label: '我的', isSelected: _selectedIndex == 2, onTap: () => setState(() => _selectedIndex = 2)),
              ],
            ),
          ),
        ),
