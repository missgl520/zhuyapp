...
class DogPainter extends CustomPainter {
  ...
  void _drawEars(Canvas canvas, Offset center, double radius) {
    ...
    // 耳内颜色
    final innerEarPaint = Paint()..color = Colors.pink.shade200.withOpacity(0.5);
    canvas.drawCircle(
  ...
  void _drawFace(Canvas canvas, Offset center, double radius) {
    ...
    // 腮红
    final blushPaint = Paint()..color = Colors.pink.shade200.withOpacity(0.35);
    canvas.drawOval(
      Rect.fromCenter(
  ...
  void _drawMouth(Canvas canvas, Offset headCenter, double radius) {
    ...
    switch (mood) {
      case PetMood.happy:
        ...
        // 舌头
        final tonguePaint = Paint()..color = Colors.pink.shade300;
        canvas.drawOval(
          Rect.fromCenter(
      ...
      case PetMood.excited:
        // 张嘴大笑
        final fillPaint = Paint()..color = Colors.pink.shade300;
        canvas.drawOval(
          Rect.fromCenter(
